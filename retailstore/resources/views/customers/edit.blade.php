<div>
    ...
    <form action="{{ route('customers.update', $customer->customer_id) }}" method="POST">
        ...
        <input type = "password" id="password" name="password_hash" value="{{old('password_hash', $customer->password_hash)}}"required>
        <br>
        ...
        <textarea id="address" name="address" rows = "4" cols = "50" value="{{old('address', $customer->address)}}"></textarea>
        <br>
